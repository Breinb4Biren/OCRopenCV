...
def extract_text_from_images(image_folder):
    ...
    for filename in sorted(os.listdir(image_folder)):
        if filename.endswith(".png"):
            ...
            sharpened = cv2.addWeighted(processed_image, 1.5, cv2.GaussianBlur(processed_image, (5,5), 0), -0.5, 0)

            # Extract text using Tesseract
            extracted_text = pytesseract.image_to_string(sharpened, lang='eng', config='--psm 6')
